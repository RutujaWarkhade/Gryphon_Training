...
public class JDBC_5 extends JFrame implements ActionListener {
    ...
    JDBC_5() {
        ...
        try {
            ...
            rs = st.executeQuery("SELECT * FROM stds_scoe_cs_b");
    ...
    public static void main(String[] args) {
        JDBC_5 op = new JDBC_5();
        op.setVisible(true);
        op.setSize(500, 400);
        op.setTitle("Student Navigator");
